...
<svg width="48" height="48" viewBox="0 0 100 100" xmlns="http:
...
clippy.querySelector('#clippyMessage').textContent = message;const dismissBtn = clippy.querySelector('#clippyDismissBtn');
